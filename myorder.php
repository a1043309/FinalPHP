...
<body>
	<div class="user_wrap">
		...
		<div class="myorder_content1">
			...
			<a href="myorder.php" class="text2-1">我的訂單</a>
		...
		<div class="myorder_content2">
			...
			<?php
				$sql2 = "SELECT * FROM purchase, product WHERE (product.P_Code = purchase.P_Code AND purchase.Buyer_ID = '$UID' AND purchase.isReceive = 0)";
